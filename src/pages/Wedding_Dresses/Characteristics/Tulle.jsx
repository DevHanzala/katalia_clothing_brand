...
function Tulle() {
  const [activeFilter, setActiveFilter] = useState("Tulle");
  ...
  const filters = ["Tulle", "Light", "Romantic", "Layered"];
  ...
  const baseDressData = [
    {
      ...
      price: "$489.99",
      image: r2,
      description: "Light tulle dress with romantic flair",
      category: ["Tulle", "Light", "Romantic"],
    ...
    },
    {
      ...
      price: "$559.99",
      image: p1,
      description: "Layered tulle dress with soft design",
      category: ["Tulle", "Layered", "Romantic"],
    ...
    },
    {
      ...
      price: "$509.99",
      image: i3,
      description: "Classic tulle dress with light fabric",
      category: ["Tulle", "Light"],
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/tulle" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>Tulle</span>
      </motion.div>
