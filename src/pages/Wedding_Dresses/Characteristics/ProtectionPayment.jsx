...
function ProtectionPayment() {
  const [activeFilter, setActiveFilter] = useState("Protection Payment");
  ...
  const filters = ["Protection Payment", "Secure", "Modern", "Elegant"];

  const baseDressData = [
    {
      id: 1,
      name: "Protection Dress 1",
      price: "$499.99",
      image: r2,
      description: "Secure payment dress with modern design",
      category: ["Protection Payment", "Secure", "Modern"],
      relatedImages: [r2, p1, i3],
    },
    {
      id: 2,
      name: "Protection Dress 2",
      price: "$539.99",
      image: p1,
      description: "Elegant dress with secure payment features",
      category: ["Protection Payment", "Elegant", "Secure"],
      relatedImages: [p1, r2, i3],
    },
    {
      id: 3,
      name: "Protection Dress 3",
      price: "$519.99",
      image: i3,
      description: "Modern dress with protection payment options",
      category: ["Protection Payment", "Modern"],
  ...
  const filteredDresses = (() => {
    ...
    if (activeFilter !== "Protection Payment") {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/protection-payment" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>Protection Payment</span>
      </motion.div>
...
export default ProtectionPayment;