...
function Corset() {
  const [activeFilter, setActiveFilter] = useState("Corset");
  ...
  const filters = ["Corset", "Fitted", "Structured", "Elegant"];
  ...
  const baseDressData = [
    {
      ...
      price: "$569.99",
      image: r2,
      description: "Fitted corset dress with elegant design",
      category: ["Corset", "Fitted", "Elegant"],
    ...
    },
    {
      ...
      price: "$599.99",
      image: p1,
      description: "Structured corset dress with bold style",
      category: ["Corset", "Structured", "Elegant"],
    ...
    },
    {
      ...
      price: "$549.99",
      image: i3,
      description: "Classic corset dress with fitted silhouette",
      category: ["Corset", "Fitted"],
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/corset" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>Corset</span>
      </motion.div>
