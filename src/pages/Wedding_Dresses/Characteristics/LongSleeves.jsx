...
function LongSleeves() {
  const [activeFilter, setActiveFilter] = useState("Long Sleeves");
  ...
  const filters = ["Long Sleeves", "Elegant", "Velvet", "Warm"];

  const baseDressData = [
    {
      id: 1,
      name: "Long Sleeve Dress 1",
      price: "$549.99",
      image: r2,
      description: "Elegant long sleeve dress with velvet details",
      category: ["Long Sleeves", "Elegant", "Velvet"],
      relatedImages: [r2, p1, i3],
    },
    {
      id: 2,
      name: "Long Sleeve Dress 2",
      price: "$579.99",
      image: p1,
      description: "Warm long sleeve dress with soft fabric",
      category: ["Long Sleeves", "Warm", "Velvet"],
      relatedImages: [p1, r2, i3],
    },
    {
      id: 3,
      name: "Long Sleeve Dress 3",
      price: "$529.99",
      image: i3,
      description: "Classic long sleeve dress with elegant design",
      category: ["Long Sleeves", "Elegant"],
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/long-sleeves" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
