    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-28">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <Link to="/wedding-dresses/new-in" className="text-blue-600 hover:underline">New In Wedding Dresses</Link>
          <span className="mx-2">/</span>
          <span>{dressId}</span>
        </div>
        ...
        <div className="mt-8 relative">
          ...
          <div className="flex items-center">
            ...
            <div
              ref={carouselRef}
              className="flex overflow-x-auto gap-1 scrollbar-hide w-full"
