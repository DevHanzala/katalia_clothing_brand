...
function Princess() {
  // State management
  const [activeFilter, setActiveFilter] = useState("Princess");
  ...
  // Filter options
  const filters = ["Princess", "Glamorous", "Satin", "Modern"];

  // Base dress data for Princess category
  const baseDressData = [
    {
      id: 1,
      name: "Princess Dress 1",
      price: "$599.99",
      image: r2,
      description: "Glamorous princess dress with satin finish",
      category: ["Princess", "Glamorous", "Satin"],
      relatedImages: [r2, p1, i3],
    },
    {
      id: 2,
      name: "Princess Dress 2",
      price: "$649.99",
      image: p1,
      description: "Modern princess dress with elegant flair",
      category: ["Princess", "Modern", "Satin"],
      relatedImages: [p1, r2, i3],
    },
    {
      id: 3,
      name: "Princess Dress 3",
      price: "$579.99",
      image: i3,
      description: "Classic princess dress with a timeless look",
      category: ["Princess", "Glamorous"],
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/princess" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>Princess</span>
      </motion.div>
