...
function ALine() {
  // State management
  const [activeFilter, setActiveFilter] = useState("A-Line");
  ...
  // Filter options
  const filters = ["A-Line", "Vintage", "Chiffon", "Simple"];

  // Base dress data for A-Line category
  const baseDressData = [
    {
      id: 1,
      name: "A-Line Dress 1",
      price: "$449.99",
      image: p2,
      description: "Vintage A-line dress with chiffon overlay",
      category: ["A-Line", "Vintage", "Chiffon"],
    ...
    },
    {
      ...
      price: "$479.99",
      image: p3,
      description: "Simple A-line dress with elegant lines",
      category: ["A-Line", "Simple", "Chiffon"],
    ...
    },
    {
      ...
      price: "$459.99",
      image: i2,
      description: "Classic A-line dress with vintage charm",
      category: ["A-Line", "Vintage"],
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/a-line" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>A-Line</span>
      </motion.div>
