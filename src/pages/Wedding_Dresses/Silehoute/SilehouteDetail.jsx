...
function SilehoueteDetail() {
  // Get dress ID from URL and related images from location state
  const { id } = useParams();
  ...
  // Combined dress data from all categories
  const dressData = {
    1: { id: 1, name: "Siren Dress 1", price: "$499.99", description: "Elegant siren dress with a modern twist", image: i2, images: [i2, i3, r1], category: ["Siren", "Elegant", "Lace"] },
    2: { id: 2, name: "Siren Dress 2", price: "$599.99", description: "Stunning siren dress with intricate details", image: r1, images: [r1, i2, i3], category: ["Siren", "Modern", "Lace"] },
    3: { id: 3, name: "Siren Dress 3", price: "$449.99", description: "Classic siren dress with a sleek silhouette", image: i3, images: [i3, r1, i2], category: ["Siren", "Elegant"] },
    4: { id: 4, name: "Princess Dress 1", price: "$599.99", description: "Glamorous princess dress with satin finish", image: r2, images: [r2, p1, i3], category: ["Princess", "Glamorous", "Satin"] },
    5: { id: 5, name: "Princess Dress 2", price: "$649.99", description: "Modern princess dress with elegant flair", image: p1, images: [p1, r2, i3], category: ["Princess", "Modern", "Satin"] },
    6: { id: 6, name: "Princess Dress 3", price: "$579.99", description: "Classic princess dress with a timeless look", image: i3, images: [i3, p1, r2], category: ["Princess", "Glamorous"] },
    7: { id: 7, name: "A-Line Dress 1", price: "$449.99", description: "Vintage A-line dress with chiffon overlay", image: p2, images: [p2, p3, i2], category: ["A-Line", "Vintage", "Chiffon"] },
    8: { id: 8, name: "A-Line Dress 2", price: "$479.99", description: "Simple A-line dress with elegant lines", image: p3, images: [p3, p2, i2], category: ["A-Line", "Simple", "Chiffon"] },
    9: { id: 9, name: "A-Line Dress 3", price: "$459.99", description: "Classic A-line dress with vintage charm", image: i2, images: [i2, p3, p2], category: ["A-Line", "Vintage"] },
    10: { id: 10, name: "Curvy Dress 1", price: "$529.99", description: "Modern curvy dress with satin finish", image: r1, images: [r1, r2, p1], category: ["Curvy", "Modern", "Satin"] },
    11: { id: 11, name: "Curvy Dress 2", price: "$549.99", description: "Elegant curvy dress with a flattering fit", image: r2, images: [r2, p1, r1], category: ["Curvy", "Elegant", "Satin"] },
    12: { id: 12, name: "Curvy Dress 3", price: "$519.99", description: "Stylish curvy dress with modern appeal", image: p1, images: [p1, r2, r1], category: ["Curvy", "Modern"] },
  };

  // Default dress if ID not found
  const defaultDress = {
    id: dressId,
    name: `Silhouette Dress ${dressId}`,
    price: "$499.99",
    description: "Default description for silhouette dress.",
    image: i3,
    images: [i3],
    category: ["Simple"],
  };
    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-28">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <Link to={`/wedding-dresses/${currentDress.category[0].toLowerCase()}`} className="text-blue-600 hover:underline">Wedding Dresses</Link>
          <span className="mx-2">/</span>
          <span>{dressId}</span>
        </div>
...
export default SilehoueteDetail;