...
function Curvy() {
  // State management
  const [activeFilter, setActiveFilter] = useState("Curvy");
  ...
  // Filter options
  const filters = ["Curvy", "Modern", "Satin", "Elegant"];

  // Base dress data for Curvy category
  const baseDressData = [
    {
      id: 1,
      name: "Curvy Dress 1",
      price: "$529.99",
      image: r1,
      description: "Modern curvy dress with satin finish",
      category: ["Curvy", "Modern", "Satin"],
      relatedImages: [r1, r2, p1],
    },
    {
      id: 2,
      name: "Curvy Dress 2",
      price: "$549.99",
      image: r2,
      description: "Elegant curvy dress with a flattering fit",
      category: ["Curvy", "Elegant", "Satin"],
      relatedImages: [r2, p1, r1],
    },
    {
      id: 3,
      name: "Curvy Dress 3",
      price: "$519.99",
      image: p1,
      description: "Stylish curvy dress with modern appeal",
      category: ["Curvy", "Modern"],
      relatedImages: [p1, r2, r1],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/curvy" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>Curvy</span>
      </motion.div>
