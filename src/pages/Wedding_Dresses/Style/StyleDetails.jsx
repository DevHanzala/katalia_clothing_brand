...
function StyleDetails() {
  ...
  const dressData = {
    1: { id: 1, name: "Winter Dress 1", price: "$549.99", description: "Elegant winter dress with velvet accents", image: i2, images: [i2, i3, r1], category: ["Winter", "Elegant", "Velvet"] },
    2: { id: 2, name: "Winter Dress 2", price: "$619.99", description: "Warm winter dress with cozy fabric", image: r1, images: [r1, i2, i3], category: ["Winter", "Warm", "Velvet"] },
    3: { id: 3, name: "Winter Dress 3", price: "$499.99", description: "Classic winter dress with elegant design", image: i3, images: [i3, r1, i2], category: ["Winter", "Elegant"] },
    4: { id: 4, name: "Boho Dress 1", price: "$479.99", description: "Flowy boho dress with lace details", image: r2, images: [r2, p1, i3], category: ["Boho", "Flowy", "Lace"] },
    5: { id: 5, name: "Boho Dress 2", price: "$529.99", description: "Rustic boho dress with earthy tones", image: p1, images: [p1, r2, i3], category: ["Boho", "Rustic", "Lace"] },
    6: { id: 6, name: "Boho Dress 3", price: "$459.99", description: "Classic boho dress with flowy silhouette", image: i3, images: [i3, p1, r2], category: ["Boho", "Flowy"] },
    7: { id: 7, name: "Civil Marriage Dress 1", price: "$429.99", description: "Minimal civil marriage dress with satin finish", image: p2, images: [p2, p3, i2], category: ["Civil Marriage", "Minimal", "Satin"] },
    8: { id: 8, name: "Civil Marriage Dress 2", price: "$449.99", description: "Elegant civil marriage dress with clean lines", image: p3, images: [p3, p2, i2], category: ["Civil Marriage", "Elegant", "Satin"] },
    9: { id: 9, name: "Civil Marriage Dress 3", price: "$419.99", description: "Simple civil marriage dress with minimal design", image: i2, images: [i2, p3, p2], category: ["Civil Marriage", "Minimal"] },
    10: { id: 10, name: "Simple Dress 1", price: "$399.99", description: "Modern simple dress with clean lines", image: r1, images: [r1, r2, p1], category: ["Simple", "Modern", "Minimal"] },
    11: { id: 11, name: "Simple Dress 2", price: "$429.99", description: "Classic simple dress with minimal design", image: r2, images: [r2, p1, r1], category: ["Simple", "Classic", "Minimal"] },
    12: { id: 12, name: "Simple Dress 3", price: "$389.99", description: "Simple dress with modern elegance", image: p1, images: [p1, r2, r1], category: ["Simple", "Modern"] },
  };

  const defaultDress = {
    id: dressId,
    name: `Style Dress ${dressId}`,
    price: "$499.99",
    description: "Default description for style dress.",
    image: i3,
    images: [i3],
    category: ["Simple"],
  };
