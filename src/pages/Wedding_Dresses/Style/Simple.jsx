...
function Simple() {
  ...
  const filters = ["Simple", "Modern", "Minimal", "Classic"];
  ...
  const baseDressData = [
    {
      ...
      price: "$399.99",
      image: r1,
      description: "Modern simple dress with clean lines",
      category: ["Simple", "Modern", "Minimal"],
    ...
    },
    {
      ...
      price: "$429.99",
      image: r2,
      description: "Classic simple dress with minimal design",
      category: ["Simple", "Classic", "Minimal"],
    ...
    },
    {
      ...
      price: "$389.99",
      image: p1,
      description: "Simple dress with modern elegance",
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/simple" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>Simple</span>
      </motion.div>
