...
function Winter() {
  ...
  const filters = ["Winter", "Elegant", "Velvet", "Warm"];
  ...
  const baseDressData = [
    {
      ...
      price: "$549.99",
      image: i2,
      description: "Elegant winter dress with velvet accents",
      category: ["Winter", "Elegant", "Velvet"],
    ...
    },
    {
      ...
      price: "$619.99",
      image: r1,
      description: "Warm winter dress with cozy fabric",
      category: ["Winter", "Warm", "Velvet"],
    ...
    },
    {
      ...
      price: "$499.99",
      image: i3,
      description: "Classic winter dress with elegant design",
      category: ["Winter", "Elegant"],
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/winter-wedding-dress" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
        <span>Winter</span>
      </motion.div>
