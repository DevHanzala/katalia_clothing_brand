...
function CivilMarriage() {
  const [activeFilter, setActiveFilter] = useState("Civil Marriage");
  ...
  const filters = ["Civil Marriage", "Minimal", "Satin", "Elegant"];

  const baseDressData = [
    {
      id: 1,
      name: "Civil Marriage Dress 1",
      price: "$429.99",
      image: p2,
      description: "Minimal civil marriage dress with satin finish",
      category: ["Civil Marriage", "Minimal", "Satin"],
      relatedImages: [p2, p3, i2],
    },
    {
      id: 2,
      name: "Civil Marriage Dress 2",
      price: "$449.99",
      image: p3,
      description: "Elegant civil marriage dress with clean lines",
      category: ["Civil Marriage", "Elegant", "Satin"],
      relatedImages: [p3, p2, i2],
    },
    {
      id: 3,
      name: "Civil Marriage Dress 3",
      price: "$419.99",
      image: i2,
      description: "Simple civil marriage dress with minimal design",
      category: ["Civil Marriage", "Minimal"],
      relatedImages: [i2, p3, p2],
    },
  ];
  ...
  const filteredDresses = (() => {
    ...
    if (activeFilter !== "Civil Marriage") {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 pt-20 md:pt-24">
      ...
      >
        ...
        <span className="text-blue-600">
          <Link to="/wedding-dresses/civil-marriage" className="hover:underline">Wedding Dresses</Link>
        </span>
        <span className="mx-2">/</span>
